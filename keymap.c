 ...
 * |LCTRL |   Z  |   X  |   C  |   V  |   B  |-------.-------.  ,---------------|   N  |   M  |   ,  |   .  |   /  |  \   |
 * `-----------------------------------------/  Del  /       /   \       \   BS  \----------------------------------------'
 *                          |ADJUST|LOWER | /-------/ Space /     \ Enter \-------\  |RAISE | Win  |
 *                          |      |      |/  LAlt /       /       \       \ RCTRL \ |      |      |
 *                          `-----------------------------'         '------------------------------'
 */
 [_QWERTY] = LAYOUT( \
  ...
  KC_LCTRL,  KC_A, KC_S, KC_D, KC_F,    KC_G,                                      KC_H,    KC_J,    KC_K,    KC_L,   KC_SCLN, JP_QUOT, \
  KC_LSFT, KC_Z, KC_X, KC_C, KC_V,    KC_B,   KC_DEL, KC_ENT, KC_SPC, KC_BSPC,     KC_N,    KC_M,    KC_COMM, KC_DOT, JP_SLSH, JP_BSLS, \
                              ADJUST, LOWER,   KC_LALT,                KC_RCTRL,      RAISE,   KC_RGUI\
  ),
 ...
 * |  ~   |   !  |   "  |   #  |   $  |   %  |                                  |   &  |   "  |   (  |   )  |   =  |   |  |
 * |------+------+------+------+------+------|                                  |------+------+------+------+------+------|
 * | Tab  |   /  |   -  |   7  |   8  |   9  |                                  |   -  | BTN1 | BTN2 | BTN3 |   /  |   :  |
 * |------+------+------+------+------+------|                                  |------+------+------+------+------+------|
 * |LShift|   *  |   +  |   4  |   5  |   6  |                                  |   +  |SC_DWN| M_UP |SC_UP |   *  |   ~  |
 * |------+------+------+------+------+------|                                  |------+------+------+------+------+------|
 * |LCTRL |   .  |   0  |   1  |   2  |   3  |-------.-------.  ,---------------|   @  |M_LEFT|M_DOWN|M_RIGHT|  ?  |  BS  |
 * `-----------------------------------------/   [   /       /   \       \   "   \----------------------------------------'
 *                          | LGUI | LOWER| /-------/ Space /     \ Enter \-------\  |     | Win  |
 *                          |      |      |/   ]   /       /       \       \  '    \ |      |      |
 *                          `-----------------------------'         '------------------------------'
 */
 [_LOWER] = LAYOUT( \
  KC_TILD, JP_EXLM, JP_DQT,  JP_HASH, JP_DLR,  JP_PERC,                                      JP_AMPR, JP_DQT,      JP_LPRN,    JP_RPRN,       JP_EQL,  JP_PIPE, \
  _______, KC_PSLS, KC_PMNS, KC_P7,   KC_P8,   KC_P9,                                        KC_PMNS, KC_MS_BTN1,  KC_MS_BTN2, KC_MS_BTN3,    JP_SLSH, JP_COLN, \
  _______, KC_PAST, KC_PPLS, KC_P4,   KC_P5,   KC_P6,                                        KC_MINS, KC_MS_WH_UP, KC_MS_UP,   KC_MS_WH_DOWN, JP_ASTR, KC_TILD, \
  _______, KC_PDOT, KC_P0,   KC_P1,   KC_P2,   KC_P3,   JP_LBRC,  _______, _______, JP_DQT, JP_AT,   KC_MS_LEFT,   KC_MS_DOWN, KC_MS_RIGHT,   JP_QUES, KC_BSPC, \
                                       KC_LGUI, LOWER, JP_RBRC,                    JP_QUOT, JP_QUOT, _______\
 ...
 */
 [_RAISE] = LAYOUT( \
  ...
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,    KC_F6,                                       XXXXXXX, XXXXXXX, KC_UP,   XXXXXXX, XXXXXXX, _______, \
  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,   KC_F12,  XXXXXXX, _______, _______, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX, \
