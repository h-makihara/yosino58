 ...
 * |LCTRL |   Z  |   X  |   C  |   V  |   B  |-------.-------.  ,---------------|   N  |   M  |   ,  |   .  |   /  |  \   |
 * `-----------------------------------------/  Del  /       /   \       \  RAlt \----------------------------------------'
 *                          |  Wim |LOWER | /-------/ Space /     \ Space \-------\  |RAISE |Adjust|
 *                          |      |      |/ LCtrl /       /       \       \   `   \ |      |      |
 *                          `-----------------------------'         '------------------------------'
 */
 [_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,   KC_Z, KC_X, KC_C, KC_V, KC_B,   KC_DEL, KC_SPC,    KC_SPC, KC_RALT, KC_N, KC_M, KC_COMM, KC_DOT, JP_SLSH, JP_YEN, \
                          KC_LGUI, LOWER,   KC_LCTRL,                        KC_GRV, RAISE, ADJUST\
  ),
 ...
 */
 [_LOWER] = LAYOUT( \
  ...
  _______, KC_PDOT, KC_P0,   KC_P1,   KC_P2,   KC_P3,   JP_LBRC,  _______, _______, JP_DQT, JP_AT,   KC_MS_LEFT,   KC_MS_DOWN, KC_MS_RIGHT,   JP_QUES, KC_BSPC, \
                                       KC_LGUI, LOWER, JP_RBRC,                    JP_QUOT, JP_UNDS, _______\
 ...
 */
 [_RAISE] = LAYOUT( \
  ...
  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,   KC_F12,  JP_LCBR, _______, _______, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX, \
                                      XXXXXXX,  XXXXXXX, JP_RCBR,                   XXXXXXX, _______, XXXXXXX \
  ),
