 ...
 */
 [_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,  KC_A, KC_S, KC_D, KC_F,    KC_G,                                       KC_H,    KC_J,    KC_K,    KC_L,   KC_SCLN, JP_QUOT, \
  KC_LCTRL, KC_Z, KC_X, KC_C, KC_V,    KC_B,   KC_DEL, KC_SPC, KC_ENT, JP_LBRC,    KC_N,    KC_M,    KC_COMM, KC_DOT, JP_SLSH, JP_BSLS, \
                              ADJUST, LOWER,   KC_LALT,                JP_RBRC,    RAISE,   KC_RGUI\
  ),
 ...
 */
 [_LOWER] = LAYOUT( \
  KC_ESC,  JP_EXLM, JP_DQT,  JP_HASH, JP_DLR,  JP_PERC,                                      JP_AMPR, JP_QUOT,     JP_LPRN,    JP_RPRN,       JP_EQL,  JP_PIPE, \
  ...
  _______, KC_PDOT, KC_P0,   KC_P1,   KC_P2,   KC_P3,   _______,  _______, _______, _______, KC_P0,   KC_MS_LEFT,  KC_MS_DOWN, KC_MS_RIGHT,   JP_UNDS, KC_BSPC, \
                                       _______, KC_LGUI, _______,                    XXXXXXX, JP_QUOT, JP_DQT\
 ...
 */
 [_RAISE] = LAYOUT( \
  ...
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,    KC_F6,                                       XXXXXXX, _______, KC_UP,   _______, _______, _______, \
  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,   KC_F12,  XXXXXXX, _______, _______, XXXXXXX, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, \
